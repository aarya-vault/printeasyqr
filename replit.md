...
- **Strict Development Database Mode**: Production database manually deleted by user. System enforced to strictly use ONLY development DATABASE_URL for ALL environments (development, testing, deployment). Maintains stable dataset of 131 authentic shops with zero duplicates. Complete elimination of database confusion through single-source architecture.
