...
async function importDiverseShops() {
  try {
    ...
    csvStream.on('end', async () => {
      ...
      // Import first 30 shops for diverse demo
      const selectedShops = csvData.slice(0, 30);
      ...
      for (const row of selectedShops) {
        ...
        try {
          ...
          // Show working hours type for diversity check
